...
| Project         | Description                                                                                         | Tech                                | Source Code                                                                                                          | Try it
| ----------------------- | ----------------------------------------------------------------------------------------------- | ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------ | --------- |
| **Home Finder**           | A web app that allows a person who is looking to move into North/North-West London to search for postcode districts that fall within the desired commute time to their office.       | Python, Flask, GoogleMapsAPI, HTML, CSS, Heroku             | [Github](https://github.com/farhaan-ali/homefinder)                                     | [Here](https://tranquil-sea-13127.herokuapp.com)   |
| **Subscrypt**      | Final Project at Makers Academy. A proof of concept subscription manager utilising Open Banking to read in recurring subscriptions and SendGrid to send calendar events via e-mail to remind users to cancel subscriptions. | Go, Javascript, HTML, CSS, PostgreSQL, Github Actions | [Github](https://github.com/farhaan-ali/subscrypt)            | [Here](https://fathomless-crag-50750.herokuapp.com/)  |
| **Acebook**      | A Facebook clone redesigned | Rails, Ruby, RSpec, PostgreSQL, HTML, Javascript, CSS               | [Github](https://github.com/farhaan-ali/acebook-team-rex) | [Here](https://acebook-trex.herokuapp.com/) |
| **Bank Tech Test**    | A small test-driven program to interact within the command line    | Javascript, Jest, Travis CI            | [Github](https://github.com/farhaan-ali/bank-tech-test) | See Repository |
